frappe.pages['driver-assignment'].on_page_load = function(wrapper) {
	...
	$barcode_section.find('.barcode-input').on('keypress', function(e) {
		...
		frappe.call({
			method: 'masar_miraaya_shipping.masar_miraaya_shipping.page.driver_assignment.driver_assignment.get_so_dispatch_details',
			args: {
	...
	$orders_container.on('click', '.assign-driver-btn', function() {
		...
		frappe.confirm(
			...
			function() {
				frappe.call({
					method: 'masar_miraaya_shipping.masar_miraaya_shipping.page.driver_assignment.driver_assignment.assign_driver_and_dispatch',
					args: {
