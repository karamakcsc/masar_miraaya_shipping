frappe.pages['picking'].on_page_load = function(wrapper) {
	...
	function render_orders(order) {
		...
		frappe.call({
			method: 'masar_miraaya_shipping.masar_miraaya_shipping.page.picking.picking.get_confirmed_sales_orders',
			args: {
				so: order
			},
			callback: function(r) {
	...
	function open_pick_list(sales_order) {
		frappe.call({
			method: 'masar_miraaya_shipping.masar_miraaya_shipping.page.picking.picking.get_picklist_from_so',
			args: {
				so: sales_order
			},
			callback: function(r) {
